...
const Gemini = (function () {
  ...
  function promptFor(from, to) {
    return [
      ...
      "",
      "THIS IS THE MIDDLE OF A DOCUMENT, NOT THE START OF ONE.",
      "Other clips cover what comes before and after. Do NOT open with a recap,",
      "an introduction, or a summary of what the video is about — begin with",
      "whatever is happening at the first moment of this clip and stop at the",
      "last. A reader will see your lines joined to the others in order.",
      "",
      "WRITE ONLY WHAT IS IN THIS CLIP.",
      "Do not use general knowledge about this game, series, or channel to fill",
      "a gap, and do not describe anything you have not actually seen or heard",
      "here. Some stretches are quiet or uneventful — say so briefly and move",
      "on. If you are unsure what happened, say less.",
      "",
